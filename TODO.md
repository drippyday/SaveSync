# SaveSync — TODO / backlog

## Recently completed (sync UX + server)

- **Auto (full) sync** on Switch and 3DS driven by **SHA-256** and per-device **`.savesync-baseline`** (not unreliable SD mtimes for merge decisions).
...
- Deeper **Delta / iOS** integration (today: **desktop bridge** only).
