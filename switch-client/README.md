...
5. **Auto (A):** baseline file **`.gbasync-baseline`** + SHA-256 (legacy **`.savesync-baseline`** still supported; not SD mtime policy); first-run **SKIP** until X/Y seeds baseline; **Conflict** UI (X/Y/B)
